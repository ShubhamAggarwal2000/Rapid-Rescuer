...
uint8_t setSignalRateLimit(int x,float limit_Mcps);
...
uint8_t setVcselPulsePeriod(int x,vcselPeriodType type, uint8_t period_pclks);
...
//---------------------------------------------------------
void writeReg(int x,uint8_t reg, uint8_t value);        // Write an 8-bit register
void writeReg16Bit(int x,uint8_t reg, uint16_t value);  // Write a 16-bit register
void writeReg32Bit(int x,uint8_t reg, uint32_t value);  // Write a 32-bit register
uint8_t readReg(int x,uint8_t reg);                     // Read an 8-bit register
uint16_t readReg16Bit(int x,uint8_t reg);               // Read a 16-bit register
uint32_t readReg32Bit(int x,uint8_t reg);               // Read a 32-bit register
